...
ui_stack:="angular_material(pure_priority)∧solve_with_material_first∧aesthetic(100%_google)∧css(pure_for_corporate_branding)∧!scss∧!tailwind∧min(custom_html)∧!hardcoded_colors∧use(css_vars:--color-corporativo)"
